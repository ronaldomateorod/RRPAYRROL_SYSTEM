...
namespace RRPAYRROL_SYSTEM.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,Codigo,NumDeCuenta,CreadoPor,ModificadoPor,IdPersonaFK,IdPuestoFK,IdContratoFK,IdEstadoFK")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpleado,Codigo,NumDeCuenta,CreadoPor,ModificadoPor,IdPersonaFK,IdPuestoFK,IdContratoFK,IdEstadoFK")] Empleado empleado)
        {
